# Stage 5N Prompt-7 Micro-SFT Data Report

Date: 2026-05-16

## Scope

Stage 5N is a conservative micro-SFT repair from a stable previous adapter. It
exists because:
...
data/processed/sft_stage5n_prompt7_micro_eval.jsonl
```
...
- Train rows: 116
- Eval rows: 13
- Prompt-7 train rows: 74
- Replay train rows: 42
- Prompt-7 eval rows: 6

## Design

- Intended init adapter: `outputs/dpo_lora_qwen05b_naive_v6`.
